...
{
  // To get the value, compute the value of the A and
  // B operands, and combine them with the operator.
  double leftVal = A->value();

  double rightVal = B->value();
