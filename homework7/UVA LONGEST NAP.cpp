...
const int TOTAL_MINUTES = 8 * 60; // since 10:00 to 18:00
...
int main()
{
  ...
  vector<bool> timeAvailable(TOTAL_MINUTES + 2); // make a vector of all possible time you can use
  timeAvailable[TOTAL_MINUTES + 1] = false; // add a ending false
